...
社内SEとして社内システムの保守・運用、データ分析業務に従事。
...
- 情報処理技術者試験
	- 基本情報技術者
		- [エセ情報系学生が基本情報技術者試験に受かるまで](2009-11-26-1259191598.md)
	- 応用情報技術者
		- [Evernoteで応用情報の資格勉強を！](2010-04-20-1271768497.md)
	- 情報セキュリティスペシャリスト
		- [iPhone×iPadで学ぶ僕の情報処理試験勉強法](/blog/2010/12/20/1292850614/)
	- ネットワークスペシャリスト
		- [iPadとScrapboxで楽しく学ぶ資格学習法　〜手書きデジタルノートとネットワーク型ノートツールのすすめ〜](2023-12-28-how-to-learn-with-ipad-and-scrapbox.md)
	- データベーススペシャリスト
	- システムアーキテクト
- データ分析
	- DATA Saber認定
...
当サイトのコンテンツは、可能な限り正確な情報を掲載するように努めていますが、誤りや情報が古くなっている可能性があります。
