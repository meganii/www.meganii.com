...
- Society5.0 平太王のため、AI人材の育成の抜本的な加速化が必要


## AI時代のエンジニア生存戦略

- datum studio 安部 @kos59125
...
- 無理解の壁
    - 全てのスキルをつけるのは難しい
    - お互いを理解しないと、データ利活用を進まない


- c.f. データサイエンティスト協会「データサイエンティストのミッション、スキルセット、定義、スキルレベルを発表」
