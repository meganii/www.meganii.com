...
lastmod: 2021-03-13T22:45:57+09:00
published: false
category: ["Gadget"]
tags: ["PC","Windows"]
comment: true
...
また、せっかく`Oculus Quest 2`を購入したので、VRも楽しみたい。

さらには、在宅勤務対応のためモニターもキーボードも購入したので、あとはPC本体のみの状態になり、
デスクトップPCを購入する機運が高まって、対象を検討する。
...
## 自作 or BTO（Build To Order）

今回を機に自作PCにチャレンジするかどうかも悩んだ。
