...
lastmod: 2021-02-12T22:57:15+09:00
comments: true
category: ['Tech']
...
`Windows Communication Foundation(WCF)`, `Silverlight`周りで出てくるドメインサービスとは一体なにものだろうか。
ドメイン駆動設計（DDD）の文脈から読み解いてみる。
