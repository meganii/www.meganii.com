...
![](https://res.cloudinary.com/meganii/image/upload/c_scale,w_640,f_auto/v1511095930/f4wmdqgwy2pcne4f9nr7.png "=640x354")

### 3. [ドメイン設定] MXレコードとCNAMEを追加する。

Domain Whitelabl登録時に表示されるCNAMEと、MXレコードをご自身のドメイン管理サイト(お名前.com)に、以下3レコードを追加します。

![](https://res.cloudinary.com/meganii/image/upload/c_scale,w_640,f_auto/v1511045848/gzkrcrwjrmivsqqhtw9h.jpg "=640x190")
...
![](https://res.cloudinary.com/meganii/image/upload/c_scale,w_640,f_auto/v1511051917/m3sgzyg5xzftm2c3c5pi.jpg "=640x480")
...
![](https://res.cloudinary.com/meganii/image/upload/c_scale,w_640,f_auto/v1511052504/ztj0duzot0rtit4olqc3.png "=640x480")
...
![](https://res.cloudinary.com/meganii/image/upload/c_scale,w_640,f_auto/v1511048426/ga8ugnnbstfhbshvt9mz.jpg "=640x480")
