...
![](https://res.cloudinary.com/meganii/image/upload/v1616832234/8000e32250f48579625c126e08fdafaa_izvwpr.png "=209x147")


2. 「設定 > 個人用アクセス」の「トークン名」に任意のトークン名を入力し、「新しいトークンの作成」をクリック

![](https://res.cloudinary.com/meganii/image/upload/v1616832929/63c27ce8088626c641eefb0e691c36e6_aqcbcf.png "=1155x327")

3. 作成された「トークンシークレット」を控えておく

![](https://res.cloudinary.com/meganii/image/upload/v1616833105/50e7f2dfc1cd4e1ae174a9820bf368ee_a685e5.png "=501x248")
