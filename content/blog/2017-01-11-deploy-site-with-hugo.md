...
[Hugoで生成した静的サイトのホスト先をさくらVPSからNetlifyに変更する \- SIS Lab](/blog/2017/03/19/migrate-hugo-hosting-service-from-sakura-vps-to-netlify/)

2018/12/13追記
NetlifyからGitHub Pagesに変更しました。  
[NetlifyからGitHub Pagesに移行した件 \- SIS Lab](/blog/2018/12/12/migration-netlify-to-github-pages/)
