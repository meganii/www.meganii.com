...
1年使った場合の想定です。GMOインターネットのキャッシュバックが激アツです。
...
3年ほどさくらVPSを利用してきたため、Conoha VPSに移行するのは少し名残惜しいですが、月々の利用料を考えると仕方ないと移行しました。逆に言うと、VPSやドメインを利用している方はGMOインターネットの株主優待を有効活用することで、かなりお得にVPSを利用できます。
